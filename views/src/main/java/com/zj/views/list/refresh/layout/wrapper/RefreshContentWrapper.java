...
import com.zj.views.list.refresh.layout.util.DesignUtil;
...
import static com.zj.views.list.refresh.layout.util.SmartUtil.isTransformedTouchPointInView;
import static com.zj.views.list.refresh.layout.util.SmartUtil.measureViewHeight;
import static com.zj.views.list.refresh.layout.util.SmartUtil.scrollListBy;
...
public class RefreshContentWrapper implements RefreshContent, CoordinatorLayoutListener, AnimatorUpdateListener {
    ...
    public void setUpComponent(RefreshKernel kernel, View fixedHeader, View fixedFooter) {
        ...
        if (fixedHeader != null || fixedFooter != null) {
            ...
            if (fixedHeader != null) {
                fixedHeader.setTag(R.id.rl_tag, "fixed-top");
