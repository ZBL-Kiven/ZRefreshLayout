...
public interface RefreshComponent extends OnStateChangedListener {
     ...
     */
    @RestrictTo({LIBRARY, LIBRARY_GROUP, SUBCLASSES})
    void onReleased(@NonNull RefreshLayoutIn refreshLayout, int height, int maxDragHeight);
     ...
     */
    @RestrictTo({LIBRARY, LIBRARY_GROUP, SUBCLASSES})
    void onStartAnimator(@NonNull RefreshLayoutIn refreshLayout, int height, int maxDragHeight);
     ...
     */
    @RestrictTo({LIBRARY, LIBRARY_GROUP, SUBCLASSES})
    int onFinish(@NonNull RefreshLayoutIn refreshLayout, boolean success);
